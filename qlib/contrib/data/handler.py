...
from qlib.contrib.data.loader import Alpha101DL, Alpha158DL, Alpha360DL
...
class Alpha101(DataHandlerLP):
    ...
    def get_feature_config(self, config=None):
        return Alpha101DL.get_feature_config(config)
